  ...
  return (
    <section className='bg-zinc-900 py-32 border-b-4 border-light-green'>
      <div className='container mx-auto'>
        ...
        {/* RowCols here */}
        <div className='grid gap-x-8 lg:gap-x-0 gap-y-10 grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 xl:grid-cols-8'>
          <SkillsCardItem
            imagePath='/logos/html.png'
            title='HTML'
            // description='Proficient in structuring web content using semantic HTML tags'
          />
          <SkillsCardItem
