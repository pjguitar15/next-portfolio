      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='lg:col-span-2'>
            ...
            {/* Availability Status */}
            <div className='mt-6 inline-flex items-center px-4 py-2 bg-teal-900/30 text-teal-400 rounded-full text-sm font-medium border border-teal-800'>
                ...
                <li key={link.name}>
                  ...
                  >
                    ...
                    {isActivePage(link.href) && (
                      <div className='w-1.5 h-1.5 bg-teal-400 rounded-full ml-2'></div>
                    )}
                  </Link>
                </li>
              ))}
              ...
              <div className='flex gap-3'>
                {socialLinks.map((social) => (
                  <a
                    ...
                    className='p-3 bg-zinc-800 rounded-lg hover:bg-zinc-700 transition-colors duration-200 group'
                    title={social.name}
                  >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
            <div className='flex items-center gap-2 text-zinc-400 text-sm'>
              <span>
                &copy; {currentYear} Philcob Josol. All rights reserved.
              </span>
            </div>
